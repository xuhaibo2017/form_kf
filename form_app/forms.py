...
class loginForm(forms.Form):
    username = fields.CharField(
        required=True,
        widget=widgets.TextInput(attrs={'class': "text form-control", 'placeholder': '请输入用户名','style':'color: #FFFFFF !important'}),
        min_length=6,
        max_length=12,
        strip=True,
    ...
    pwd = fields.CharField(
        widget=widgets.PasswordInput(attrs={'class': "text form-control", 'placeholder': '请输入密码','style':'color: #FFFFFF !important'}),
        required=True,
        min_length=6,
        max_length=12,
        strip=True,
